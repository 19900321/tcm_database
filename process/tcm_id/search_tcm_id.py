...
def get_herb_active_ingredient_pairs():
    database_name = 'tcm_id'
    sql = """SELECT
                    *
                    FROM
...
def get_key_numbers_values():
    ...
    def get_herb_ingredient_stat():
        herb_ingredient_all_pairs = get_herb_ingredient_pairs()
        herb_active_ingredient_pairs = get_herb_active_ingredient_pairs()
